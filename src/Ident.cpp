...
/**
 * Устанавливает значение счетчика идентификатора по строковому выражению
 * @param identifier - корректная строка отображающая идентификатор (корректность с точки зрения задания)
 * @return - истину если счетчик принял новое значение после парсинга строки
 */
...
/**
 * Возвращает строковое выражение текущего значения счетчика идентификатора
 * @return - строку идентификатора
 */
...
/**
 * Метод выполняет приращение счетчика на +1
 * @return - строку идентификатора соответствующую новому значению счетчика
 */
